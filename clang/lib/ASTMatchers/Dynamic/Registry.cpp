...
RegistryMaps::RegistryMaps() {
  ...
  REGISTER_MATCHER(capturedDecl);
  REGISTER_MATCHER(capturedStmt);
  ...
  REGISTER_MATCHER(hasAssociatedStmt);
  ...
  REGISTER_MATCHER(ompAtomicDirective);
  REGISTER_MATCHER(ompBarrierDirective);
  REGISTER_MATCHER(ompCancelDirective);
  REGISTER_MATCHER(ompCancellationPointDirective);
  REGISTER_MATCHER(ompCriticalDirective);
  REGISTER_MATCHER(ompDepobjDirective);
  REGISTER_MATCHER(ompDispatchDirective);
  REGISTER_MATCHER(ompErrorDirective);
  REGISTER_MATCHER(ompFlushDirective);
  REGISTER_MATCHER(ompInteropDirective);
  REGISTER_MATCHER(ompMaskedDirective);
  REGISTER_MATCHER(ompMasterDirective);
  REGISTER_MATCHER(ompMetaDirective);
  REGISTER_MATCHER(ompOrderedDirective);
  REGISTER_MATCHER(ompParallelDirective);
  REGISTER_MATCHER(ompParallelMaskedDirective);
  REGISTER_MATCHER(ompParallelMasterDirective);
  REGISTER_MATCHER(ompParallelSectionsDirective);
  REGISTER_MATCHER(ompScanDirective);
  REGISTER_MATCHER(ompSectionDirective);
  REGISTER_MATCHER(ompSectionsDirective);
  REGISTER_MATCHER(ompSingleDirective);
  REGISTER_MATCHER(ompTargetDataDirective);
  REGISTER_MATCHER(ompTargetDirective);
  REGISTER_MATCHER(ompTargetEnterDataDirective);
  REGISTER_MATCHER(ompTargetExitDataDirective);
  REGISTER_MATCHER(ompTargetParallelDirective);
  REGISTER_MATCHER(ompTargetTeamsDirective);
  REGISTER_MATCHER(ompTargetUpdateDirective);
  REGISTER_MATCHER(ompTaskDirective);
  REGISTER_MATCHER(ompTaskgroupDirective);
  REGISTER_MATCHER(ompTaskwaitDirective);
  REGISTER_MATCHER(ompTaskyieldDirective);
  REGISTER_MATCHER(ompTeamsDirective);
  REGISTER_MATCHER(ompDistributeDirective);
  REGISTER_MATCHER(ompDistributeParallelForDirective);
  REGISTER_MATCHER(ompDistributeParallelForSimdDirective);
  REGISTER_MATCHER(ompDistributeSimdDirective);
  REGISTER_MATCHER(ompForDirective);
  REGISTER_MATCHER(ompForSimdDirective);
  REGISTER_MATCHER(ompGenericLoopDirective);
  REGISTER_MATCHER(ompMaskedTaskLoopDirective);
  REGISTER_MATCHER(ompMaskedTaskLoopSimdDirective);
  REGISTER_MATCHER(ompMasterTaskLoopDirective);
  REGISTER_MATCHER(ompMasterTaskLoopSimdDirective);
  REGISTER_MATCHER(ompParallelForDirective);
  REGISTER_MATCHER(ompParallelForSimdDirective);
  REGISTER_MATCHER(ompParallelGenericLoopDirective);
  REGISTER_MATCHER(ompParallelMaskedTaskLoopDirective);
  REGISTER_MATCHER(ompParallelMaskedTaskLoopSimdDirective);
  REGISTER_MATCHER(ompParallelMasterTaskLoopDirective);
  REGISTER_MATCHER(ompParallelMasterTaskLoopSimdDirective);
  REGISTER_MATCHER(ompSimdDirective);
  REGISTER_MATCHER(ompTargetParallelForDirective);
  REGISTER_MATCHER(ompTargetParallelForSimdDirective);
  REGISTER_MATCHER(ompTargetParallelGenericLoopDirective);
  REGISTER_MATCHER(ompTargetSimdDirective);
  REGISTER_MATCHER(ompTargetTeamsDistributeDirective);
  REGISTER_MATCHER(ompTargetTeamsDistributeParallelForDirective);
  REGISTER_MATCHER(ompTargetTeamsDistributeParallelForSimdDirective);
  REGISTER_MATCHER(ompTargetTeamsDistributeSimdDirective);
  REGISTER_MATCHER(ompTargetTeamsGenericLoopDirective);
  REGISTER_MATCHER(ompTaskLoopDirective);
  REGISTER_MATCHER(ompTaskLoopSimdDirective);
  REGISTER_MATCHER(ompTeamsDistributeDirective);
  REGISTER_MATCHER(ompTeamsDistributeParallelForDirective);
  REGISTER_MATCHER(ompTeamsDistributeParallelForSimdDirective);
  REGISTER_MATCHER(ompTeamsDistributeSimdDirective);

...
template <>
inline bool HasAttrMatcher<FunctionDecl>::hasAttr(const FunctionDecl &Node,
                                          attr::Kind AttrKind) {
  return llvm::any_of(Node.attrs(),
                      [&](const Attr *A) { return A->getKind() == AttrKind; });
}
...
template <>
inline bool HasAttrMatcher<VarDecl>::hasAttr(const VarDecl &Node,
                                          attr::Kind AttrKind) {
  return llvm::any_of(Node.attrs(),
                      [&](const Attr *A) { return A->getKind() == AttrKind; });
}
...
template<>
inline bool HasAttrMatcher<NamedDecl>::hasAttr(const NamedDecl &Node,
                                               attr::Kind AttrKind) {
  return llvm::any_of(Node.attrs(),
                      [&](const Attr* A) { return A->getKind() == AttrKind; });
}
